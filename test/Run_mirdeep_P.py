...
def init_bowtie ():
  ...
  os.system('cp ../TAIR9_genome.fa .')
  os.system('mkdir bowtie-index')
  #os.system('bowtie-build -f TAIR9_genome.fa bowtie-index/TAIR9_genome >/dev/null')
...
def run_mirdp_new (infile):
  inBase = infile[:-3]
  os.system('bowtie -a -v 0 bowtie-index/TAIR9_genome -f ' + infile + '>' + inBase + '.aln')
  os.system('perl convert_bowtie_to_blast.pl ' + inBase + '.aln ' + inBase + '.fa TAIR9_genome.fa >' + inBase + '.bst')
  ...
  os.system('perl excise_candidate.pl TAIR9_genome.fa ' + inBase + '_filter15_ncRNA_CDS.bst 250 >' + inBase + '_precursors.fa')
...
def run_mirdp_known (infile):
  inBase = infile[:-3]
  os.system('bowtie -a -v 0 bowtie-index/annotated_miRNA_extended -f ' + infile + ' >' + inBase + '.aln')
