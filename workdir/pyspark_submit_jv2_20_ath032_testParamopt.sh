...
#spark-submit --master ${MASTER_URL} --executor-memory ${SLURM_MEM_PER_NODE}M ../src/mirLibPipeline.py --project_path /home/cjwu/project/cjwu/init_mirLibSpark --input_path /home/cjwu/project/cjwu/init_mirLibSpark/input_ath/ 
