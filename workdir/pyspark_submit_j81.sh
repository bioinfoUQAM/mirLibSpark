...
#SBATCH --job-name=j81-mirLib10000M2n2pn-181012
...
srun -n ${NWORKERS} -N ${NWORKERS} spark-submit --master ${MASTER_URL} --executor-memory 40000M ../src/mirLibPipeline.py ../paramfile_ATH_TAIR10_graham.txt
